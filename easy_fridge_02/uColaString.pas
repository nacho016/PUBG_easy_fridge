...
function first(c: tCola): string;
function last(c: tCola): string;
procedure enqueue(var c: tCola; x: string);
...
begin
    ...
    while aux <> nil do
    begin
        s := s + aux^.info; // Agregar la información del nodo a la cadena
